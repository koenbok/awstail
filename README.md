...
- **Real-time streaming**: Continuously monitor logs as they arrive (use `--tail` flag)
- **One-time fetching**: Get historical logs without continuous monitoring (default behavior)
